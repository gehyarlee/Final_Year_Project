		...
		<div class="row">
			<div class="col-md-12">
				<table width="100%" border="1" cellspacing="1" cellpadding="3" align="center">
					<tbody>
						<tr>
						<td colspan="7" align="center"><img src="images/UNILAK_LOGO2.png" alt="unilak_logo"/><br/>
								<!-- <strong>Univerisity of Lay Adventists of Kigali</strong><br/> -->
							    <strong>KK 508 Street, Kicukiro, Kigali City</strong><br/>
								<strong>Assistance Reports</strong><br/>
								<strong>For the month(s) of <?php echo readableDate(Input::get('from')); ?> - <?php echo readableDate(Input::get('to')); ?><br/>
							</p>
						</td>
					</tr>
					<tr>
