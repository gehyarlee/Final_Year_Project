            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item bg-secondary" style="cursor: pointer;" onclick="window.location.href='lab1.php'">
                            <h2 class="number">COMLAB 1</h2>
                            <span class="desc">Status: Offline</span><br>
                            <span class="desc">Assigned: Alexander</span><br>
                            <span class="desc"><small>Location: IT Building, Ground Floor</small></span>
                            <div class="icon">
                                <i class="fas fa-power-offfas fa-power-off"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item myactive" style="cursor: pointer;" onclick="window.location.href='lab1.php'">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item bg-success" style="cursor: pointer;" onclick="window.location.href='lab1.php'">
                            <h2 class="number">COMLAB 5</h2>
                            <span class="desc">Status: Online</span><br>
                            <span class="desc">Assigned: Alexander</span><br>
                            <span class="desc"><small>Location: IT Building, Ground Floor</small></span>
                            <div class="icon">
                                <i class="fas fa-power-off"></i>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item bg-danger" style="cursor: pointer;" onclick="window.location.href='lab1.php'">
                            <h2 class="number">COMLAB 8</h2>
                            <span class="desc">Status: Online</span><br>
                            <span class="desc">Requested Assistance!!</span>
                            <div class="icon">
                                <i class="fas  fa-power-off"></i>
                            </div>
                        </div>
