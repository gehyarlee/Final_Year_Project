...
<!-- Laboratory COMLAB 4PC-->
             <section class="statistic statistic2">
                <div class="container">
                    <div class="card text-center mr-2" style="height: 100px; width: 50px; float: right;">
                        <div class="card-body">
                          <h6 class="card-title">Door</h6>
                      </div>
                    </div>
                    <div class="row">
                        <div class="card text-center mr-2 lab1" style="height: 100px; width: 100px;" data-toggle="modal" data-target="#unitmodal1">
                            <div class="card-body">
                              <h5 class="card-title">Card title</h5>
                          </div>
                      </div>
                      <div class="card text-center mr-2 lab1" style="height: 100px; width: 100px;">
                            <div class="card-body">
                              <h5 class="card-title">Card title</h5>
                          </div>
                      </div>
                    ...
                    <div class="card text-center mr-2" style="height: 225px; width: 50px; float: right;">
                    <div class="card-body">
                        <h6 class="card-title"">White &nbsp;Board</h6>
                    </div>
                    </div>
                    <div class="col-lg-10">
                        <div class="card text-center mr-2 lab1" style="margin-top: 4%; float: right; height: 150px; width: 50px;">
                        <div class="card-body">
                        <h6 class="card-title">Teacher</h6>
                        </div>
                        </div>
                        <div class="row">
                        <div class="card text-center mr-2 lab1" style="height: 100px; width: 100px; opacity: 0.0;">
                            <div class="card-body">
                              <h5 class="card-title">Card title</h5>
                          </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="card text-center mr-2 active" style="height: 100px; width: 100px;">
                            <div class="card-body">
                              <h5 class="card-title">Card title</h5>
                          </div>
                      </div>
