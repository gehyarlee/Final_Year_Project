            ...
            <section class="statistic statistic2">
              <div class="container">
                <div class="row" style="height: 100%;">
                  <div class="col-lg-2">
                    <div class="card text-center" style="margin-top: 130%; width: 100%; transform: rotate(270deg); background-color: transparent; border-color: transparent;">
                    <div class="card text-center" style="height: 50px; width: 250px;  margin-bottom: 0px; padding-bottom: 50px;">
                  ...
                  <div class="col-lg-9">
                    <div class="row">
                      <div class="card text-center mr-2 lab1" style="height: 70px; width: 100px;" data-toggle="modal" data-target="#unitmodal1">
                        <div class="card-body">
                    ...
                    <div class="row">
                      <div class="card text-center mr-2" style="height: 70px; width: 100px; opacity: 0.0">
                        <div class="card-body">
