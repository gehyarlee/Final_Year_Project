                        ...
                        <table class="table table-borderless table-data3">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">SA Name</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">Alexander</td>
                                    <td class="text-center">Replacement</td>
                                    <td class="text-center">Monitor</td>
                                    <td class="text-center">Fixed</td>
                                    <td class="text-center">
                                        <span>
                                            <a href="#" data-toggle="modal" data-target="#maintenancereports"><i title="Print?" class="text-success fas fa-eye"></i></a>&nbsp;&nbsp;&nbsp;
