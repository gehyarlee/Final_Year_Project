            ...
            <div class="container">
                ...
                <div class="row col-lg-12">
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item bg-info" style="cursor: pointer;" data-toggle="modal" data-target="#addsa">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item bg-info" style="cursor: pointer;" data-toggle="modal" data-target="#salist">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item bg-info" style="cursor: pointer;" onclick="window.location.href='lab1.php'">
...
<!-- Addddddddddd SSSSSSSSSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
            <div class="modal fade" id="addsa" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        <div class="card-body">
                            ...
                            <div class="row col-md-12 form-group">
                                <div class="col-md-4">
                                    <label for="selectSm" class=" form-control-label">Name:</label>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row col-md-12 form-group">
                                <div class="col-md-4">
                                    <label for="selectSm" class=" form-control-label">Assigned Lab:</label>
                                </div>
                                <div class="col-md-4">
                                    <div class="">
                                        <select name="select" id="select" class="form-control">
                                            <option value="0">Please Select Lab</option>
                    ...
                    <div class="modal-content">
                        <div class="card-body">
                            ...
                            <div class="row col-md-12 form-group">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" type="text" placeholder="id number" name="">
                                </div>
                            </div>
                            <div class="row col-md-12 form-group">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <select name="select" id="select" class="form-control">
                                            ...
                                            <option value="4">Criminology</option>
                            ...
                            <div class="row col-md-12 form-group">
                                <div class="col-md-4">
                                    <label for="selectSm" class=" form-control-label">Access:</label>
                                </div>
                                <div class="col-md-4">
                                    <input class="form-control" type="text" placeholder="ID Number" name="">
                                </div>
                                <div class="col-md-4">
                                    <input class="form-control" type="text" placeholder="Password" name="">
                                </div>
                            </div>
                            <hr>
                            <div class="row col-md-12 justify-content-center">
...
<!--------------------------------------- This is SA List --------------------------------------->
            <!-- modal static -->
            <div class="modal fade" id="salist" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" aria-hidden="true"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="top-campaign">
                                    <h3 class="title-3 m-b-30">Student Assistant's List</h3>
                                    <div class="table-responsive">
                                        <table class="table table-top-campaign">
                                            <tbody>
                                                <tr>
                                                    <td>Alexander the fourth</td>
                                                    <td>ComLab1</td>
                                                    <td>Friday</td>
                                                </tr>
                                                <tr>
                                                    <td>Alexander the fifth</td>
                                                    <td>ComLab2</td>
                                                    <td>Friday</td>
                                                </tr>
                                                <tr>
                                                    <td>Alexander the sixth</td>
                                                    <td>ComLab3</td>
                                                    <td>Friday</td>
                                                </tr>
                                                <tr>
                                                    <td>Alexander the seventh</td>
                                                    <td>ComLab14</td>
                                                    <td>Friday</td>
                                                </tr>
                                            </tbody>
