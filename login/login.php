            ...
            <div class="login-form">
              <form id="login_form" action="" method="post">
                <div class="form-group">
                  <label>Authorization I.D</label>
                  <input class="au-input au-input--full" type="text" name="authorizationId" placeholder="ID number">
                </div>
                <div class="form-group">
                ...
                <!-- <div class="form-group">
                  <label class=" form-control-label">Select Laboratory:</label>
                </div> -->
                <input type="hidden" name="position" value="teacher">
                <!-- <div class="form-group">
                  <select name="select" name="laboratory" id="laboratory" class="form-control" required>
  ...
  $("#login_form").submit(function(){
    $.ajax({
      ...
      success:function(res){
        if (res == 1){
          window.location = '../teachers/index.php?page=dashboard&lab='+$('#laboratory').val()+''
        }else if(res == -1){
          alert('User account or ComLab already in use.');
        } else {
